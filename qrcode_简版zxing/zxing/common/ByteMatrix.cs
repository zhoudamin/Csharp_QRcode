        ...
        public Bitmap ToBitmap()
        {
            ...
            for (int y = 0; y < height; y++)
            {
                ...
                for (int x = 0; x < width; x++)
                {
                 ...
                 //   pixels[iPixelsCounter++] = array[y][x] == BLACK ? somecolor : BLACK;
            ...
            /****************»­Í¼**********************/
            /*       int i=0,j=0;
                    for (int y = 45; y < height-45; y=y+10,i++)
                    {
                
                        for (int x = 45; x < width-45; x=x+10,j++)
                        {
                            if (array[y][x] == BLACK)
                            {
                                imatrix[i][j]=true;
...
/*
            ...
            for (int i = 45; i < width; i = i + 10)
            {
                for (int j = 45; j < height; j = j + 10)
                {
                    rect = new Rectangle((j + 10) * 10, (i + 10) * 10, 10, 10);
                    if (array[i][j] == 0)
                    {
